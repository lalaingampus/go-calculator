<template>
  <div class="hello">
      ...
      <b-container fluid>
        <b-row class="text-center">
          ...
          <form>
            ...
            <!-- Definitioning the input box and labels to get the data -->
            <div class="field">
          ...
          <!-- Define the UI for displaying calculations  -->
    ...
    &nbsp;
    <!-- Button to trigger func postreg() -->
    <div>
...
export default {
  ...
  // data variabel to all the variables for the calculator component
  data: function() {
    return {
      add: "", multi: "", sub: "", div: "", 
      num1: "", num2: ""
